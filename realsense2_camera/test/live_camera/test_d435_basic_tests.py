...
machines that don't have the D435 connected.
...
class TestD435_Change_Resolution(pytest_rs_utils.RsTestBaseClass):
    def test_D435_Change_Resolution(self,launch_descr_with_parameters):
        ...
        try:
            ...
            self.set_string_param('rgb_camera.profile', '1280x720x6')
